              ...
              <div className="el-col el-col-24 el-col-xs-24 el-col-sm-13">
                <form id="contactForm">
                  <div className="wrapper">
                    ...
                    <span className="float-placeholder">Digite seu nome</span>
                  </div>
                  <div className="el-row mg-lr-n10 el-row-custom">
                    <div className="el-col el-col-24 el-col-xs-24 el-col-sm-12 pd-lr-10">
                      <div className="wrapper">
                        ...
                        <span className="float-placeholder">Digite seu e-mail</span>
                      </div>
                    </div>
                    <div className="el-col el-col-24 el-col-xs-24 el-col-sm-12 pd-lr-10">
                      <div className="wrapper">
                        ...
                        <span className="float-placeholder">Digite seu telefone</span>
                      </div>
                    </div>
                  </div>
                  <div className="el-row mg-lr-n10 el-row-custom">
                    <div className="el-col el-col-24 el-col-xs-24 el-col-sm-12 pd-lr-10">
                      <div className="wrapper">
                        <div className="el-select appInput" required="required">
                          ...
                          <div className="el-select-dropdown el-popper">
                            <div className="el-scrollbar">
                              <div className="el-select-dropdown__wrap el-scrollbar__wrap mg-lr-n17">
                        ...
                        <span className="float-placeholder">Já é cliente?</span>
                      </div>
                    </div>
                    <div className="el-col el-col-24 el-col-xs-24 el-col-sm-12 pd-lr-10">
                      <div className="wrapper">
                          ...
                          <div className="el-select-dropdown el-popper">
                            <div className="el-scrollbar">
                              <div className="el-select-dropdown__wrap el-scrollbar__wrap mg-lr-n17">
                                <ul className="el-scrollbar__view el-select-dropdown__list">
                                  <li className="el-select-dropdown__item">
                                    <span>Interesse em empreendimento</span>
                                  </li>
                                  <li className="el-select-dropdown__item">
                                    <span>Dúvidas</span>
                                  </li>
                        ...
                        <span className="float-placeholder">Assunto</span>
                      </div>
                    </div>
                  </div>
