                    ...
                    <div className="item">
                        <div type-box="home" className="boxEmpreendimento">
                            <a href="/ficha/casaviva-morumbi" className="">
                                <picture>
                                    <source media="(max-width: 767px)" srcSet="https://casaviva-prod.s3.us-east-1.amazonaws.com/public/current-build/img/thumb_piscina.png" />
                                    <source srcSet="https://casaviva-prod.s3.us-east-1.amazonaws.com/public/current-build/img/thumb_piscina.png" />
                                    <img src="https://casaviva-prod.s3.us-east-1.amazonaws.com/public/current-build/img/thumb_piscina.png" alt="Imagem do empreendimento CasaViva Morumbi - Uma piscina" className="img-fluid" />
                                </picture>
                    ...
                    <div className="item">
                        <div type-box="home" className="boxEmpreendimento">
                            <a href="/ficha/lyne-pirituba" className="">
                                <picture>
                                    <source media="(max-width: 767px)" srcSet="https://casaviva-prod.s3.us-east-1.amazonaws.com/public/current-build/img/thumb_desk_mobile.png" />
                                    <source srcSet="https://casaviva-prod.s3.us-east-1.amazonaws.com/public/current-build/img/thumb_desk_mobile.png" />
                                    <img src="https://casaviva-prod.s3.us-east-1.amazonaws.com/public/current-build/img/thumb_desk_mobile.png" alt="Imagem do empreendimento CasaViva Pirituba - Uma piscina" className="img-fluid" />
                                </picture>
                                <div className="content">
                                    <h3>Lyne Pirituba</h3>
                                    <ul>
